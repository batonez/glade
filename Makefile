libglade.a: FreetypeFont.o Layout.o Widget.o log.o Matrix.o globals.o Path.o WavefrontObjReader.o CSVReader.o Simulator.o CollisionDetector.o Perception.o DynamicMesh.o GladeRenderer.o GladeObject.o ResourceManager.o DesktopFileManager.o glade.o builddir
	libtool -static -o build/glade/libglade.a ../../vendor/lodepng/lodepng.o build/glade/FreetypeFont.o build/glade/ResourceManager.o build/glade/Layout.o build/glade/Widget.o build/glade/log.o build/glade/Matrix.o build/glade/globals.o build/glade/Path.o build/glade/WavefrontObjReader.o build/glade/CSVReader.o build/glade/Simulator.o build/glade/CollisionDetector.o build/glade/Perception.o build/glade/DynamicMesh.o build/glade/GladeRenderer.o build/glade/GladeObject.o build/glade/glade.o build/glade/DesktopFileManager.o
...
ResourceManager.o: builddir
	clang -O0 -g -I ../../vendor/freetype-2.10.1/include -I ../../vendor/lodepng -I include -DGLADE_MACOS -c src/util/ResourceManager.cpp -o build/glade/ResourceManager.o
...
DynamicMesh.o: builddir
	clang -O0 -g -I include -DGLADE_MACOS -c src/render/DynamicMesh.cpp -o build/glade/DynamicMesh.o

GladeRenderer.o: builddir
	clang -O0 -g -I include -DGLADE_MACOS -DGL_SILENCE_DEPRECATION -c src/render/GladeRenderer.cpp -o build/glade/GladeRenderer.o
...
glade.o: builddir
	clang -O0 -g -I include -DGLADE_MACOS -c src/glade.cpp -o build/glade/glade.o
